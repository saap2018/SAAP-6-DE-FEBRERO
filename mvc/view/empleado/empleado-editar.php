...
<form id="frm-alumno" action="?c=Empleado&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select name="TipoDeDocumento" id="select" class="form-control">
...
?>
    ...
    <div class="form-group">
        ...
        <input type="text" name="Documento" value="<?php echo $alm->Documento ?>" class="form-control" placeholder="Numero de identificación" />
    </div>
    <div class="form-group">
        <label>Nombres</label>
        <input type="text" name="Nombre" value="<?php echo $alm->Nombre; ?>" class="form-control" placeholder="Nombres completos"  />
    </div>
    
    <div class="form-group">
        <label>Apellidos</label>
        <input type="text" name="Apellidos" value="<?php echo $alm->Apellidos; ?>" class="form-control" placeholder="Apellidos completos" />
    </div>
